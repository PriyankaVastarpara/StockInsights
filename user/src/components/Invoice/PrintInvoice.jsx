      ...
      <header className="mb-4">
        <div className="flex justify-between mb-2">
          <div className="text-left">
            ...
            <h2 className="text-lg font-semibold">{parsedFormData.CustomerName}</h2>
          </div>
          <div className="text-right">
            <div className="mb-8">
              ...
              <p className="text-lg font-medium">Invoice No.# {parsedFormData.billNo}</p>
            </div>
            <p className="text-md mb-2">Order No: {parsedFormData.orderNo}</p>
            <p className="text-md mb-2">Order Date: {parsedFormData.invoiceDate}</p>
